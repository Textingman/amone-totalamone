            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a href="mailto:support@totalamone.com" className="text-base font-medium hover:underline" style={{ color: '#1D4ED8' }}>support@totalamone.com</a>
                ...
                <div>
                  ...
                  <p style={{ color: '#6B7280' }}>Total Amone<br />8 The Green, Ste A<br />Dover, DE 19901</p>
                </div>
                <div>
